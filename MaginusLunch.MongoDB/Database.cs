...
using MaginusLunch.MongoDB.Attributes;
...
namespace MaginusLunch.MongoDB
{
    internal class Database<T> where T : IEntity
    {
        ...
        private static IMongoDatabase GetDatabaseFromUrl(MongoUrl url)
        {
            ...
            //const string dbName = "MaginusLunch";
            ...
            //MongoIdentity identity = new MongoInternalIdentity(dbName, "admin");
            //MongoIdentityEvidence evidence = new  new PasswordEvidence(password);
